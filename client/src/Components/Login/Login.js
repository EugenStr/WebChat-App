...
const Login = ({handleChange, loginError, email, password, handleLogin}) => {
	...
	return (
		<div className="login">
			...
			<form className="login-form">
				...
				<button type="button" className="auth-submit__login" onClick={handleLogin}>Войти!</button>
			</form>
			<p className="change-auth" >Еще не создали аккаунт?</p>
			<Link to='/auth/register' className="login-link">Регистрация!</Link>
		</div>
	)
}
